...
typedef struct _TExprNode__isset {
  _TExprNode__isset() : fn(false), vararg_start_idx(false), bool_literal(false), case_expr(false), date_literal(false), float_literal(false), int_literal(false), in_predicate(false), is_null_pred(false), like_pred(false), literal_pred(false), slot_ref(false), string_literal(false), tuple_is_null_pred(false), decimal_literal(false) {}
  bool fn;
...
class TExprNode {
 public:
  ...
  static const char* ascii_fingerprint; // = "6ACBB7652AD57B7AD68443328F2658E1";
  static const uint8_t binary_fingerprint[16]; // = {0x6A,0xCB,0xB7,0x65,0x2A,0xD5,0x7B,0x7A,0xD6,0x84,0x43,0x32,0x8F,0x26,0x58,0xE1};
...
class TExpr {
 public:
  ...
  static const char* ascii_fingerprint; // = "A0DBD8495EFAD696519DA26412C4A5C7";
  static const uint8_t binary_fingerprint[16]; // = {0xA0,0xDB,0xD8,0x49,0x5E,0xFA,0xD6,0x96,0x51,0x9D,0xA2,0x64,0x12,0xC4,0xA5,0xC7};
...
class TExprBatch {
 public:
  ...
  static const char* ascii_fingerprint; // = "FC7626530B0A8E034E9655FDA33AC566";
  static const uint8_t binary_fingerprint[16]; // = {0xFC,0x76,0x26,0x53,0x0B,0x0A,0x8E,0x03,0x4E,0x96,0x55,0xFD,0xA3,0x3A,0xC5,0x66};
