...
typedef struct _TExecSummary__isset {
  _TExecSummary__isset() : status(false), nodes(false), exch_to_sender_map(false), error_logs(false) {}
  bool status;
  bool nodes;
...
class TExecSummary {
 public:
  ...
  static const char* ascii_fingerprint; // = "59A06F387B5FF4CEFDE4F602EBBCFED7";
  static const uint8_t binary_fingerprint[16]; // = {0x59,0xA0,0x6F,0x38,0x7B,0x5F,0xF4,0xCE,0xFD,0xE4,0xF6,0x02,0xEB,0xBC,0xFE,0xD7};
