 ...
 public:
  ...
  class ScanRange : public RequestRange {
   ...
   private:
    ...
    union {
      FILE* local_file_;
      FILE* hdfs_file_; // d'b: hack. to make it local file. callee should be rewritten to use local file
//      hdfsFile hdfs_file_; // d'b: hdfs support disabled
    };
